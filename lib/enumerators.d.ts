export declare enum BraspagEnv {
    SANDBOX = "sand_box",
    PRODUCTION = "production"
}
export declare enum BraspagPaymentType {
    CREDITCARD = "CreditCard",
    DEBITCARD = "DebitCard",
    BILL = "Boleto"
}
export declare enum BraspagCurrency {
    BRL = "BRL"
}
export declare enum BraspagCountry {
    BR = "BR"
}
export declare enum BraspagProvider {
    SIMULATED = "SIMULADO",
    CIELO = "Cielo",
    CIELO30 = "Cielo30",
    REDECARD = "Redecard",
...
export declare enum BraspagCardBrand {
    MASTER = "Master",
    VISA = "Visa"
}
export declare enum BraspagTransactionStatus {
    NOTFINISHED = 0,
    AUTHORIZED = 1,
    PAYMENTCONFIRMED = 2,
    DENIED = 3,
...
export declare enum BraspagReasonCode {
    SUCCESSFUL = 0,
